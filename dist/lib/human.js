 ...
 */
export function humanFriendlyBytes(bytes, si = false, dp = 1) {
 ...
 */
export function humanFriendlyPhrase(text) {
 ...
 */
export const humanPath = (original, maxLength = 50, formatBasename) => {
    var _a;
    const tokens = original.split("/");
    const basename = (_a = tokens[tokens.length - 1]) !== null && _a !== void 0 ? _a : "";
