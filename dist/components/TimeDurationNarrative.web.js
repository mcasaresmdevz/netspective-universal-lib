...
TimeDurationSpanElement.MINUTE = 60;
TimeDurationSpanElement.HOUR = TimeDurationSpanElement.MINUTE * 60;
TimeDurationSpanElement.DAY = TimeDurationSpanElement.HOUR * 24;
TimeDurationSpanElement.WEEK = TimeDurationSpanElement.DAY * 7;
TimeDurationSpanElement.MONTH = TimeDurationSpanElement.DAY * 30;
TimeDurationSpanElement.YEAR = TimeDurationSpanElement.DAY * 365;
TimeDurationSpanElement.durationNarrative = (start, end) => {
 ...
 */
customElements.define('time-duration', TimeDurationSpanElement, { extends: 'span' });
//# sourceMappingURL=TimeDurationNarrative.web.js.map