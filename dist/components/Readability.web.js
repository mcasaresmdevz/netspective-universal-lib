class ReadabilityComponent extends HTMLElement {
    ...
    connectedCallbackRender() {
        $script("https://raw.githack.com/mozilla/readability/0.4.1/Readability.js", () => {
            const originURL = this.getAttribute(ReadabilityComponent.originUrlAttrName);
            if (originURL) {
                fetch(originURL, { redirect: "follow" }).then((response) => {
