class KrokiComponent extends HTMLElement {
    ...
    constructor() {
        ...
        this.host = this.getAttribute(KrokiComponent.hostAttrName) || "http://kroki.io";
        this.diagramType = this.getAttribute(KrokiComponent.diagramAttrName) || "plantuml";
    ...
    connectedCallback() {
        if ("$script" in window) {
            ...
            scriptElem.src = "https://cdnjs.cloudflare.com/ajax/libs/script.js/2.5.9/script.min.js";
            document.head.appendChild(scriptElem);
        }
    }
}
KrokiComponent.hostAttrName = "host";
KrokiComponent.diagramAttrName = "type";
KrokiComponent.outputAttrName = "output";
KrokiComponent.diagnoseAttrName = "diagnose";
export default KrokiComponent;
customElements.define('kroki-diagram', KrokiComponent);
//# sourceMappingURL=KrokiDiagram.web.js.map