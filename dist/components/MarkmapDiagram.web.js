...
class MarkmapComponent extends HTMLElement {
    static get observedAttributes() {
        return [
            MarkmapComponent.diagnoseAttrName
        ];
    }
    constructor() {
        // Always call super() first, this is required by the spec.
        super();
        this.diagnose = this.getAttribute(MarkmapComponent.diagnoseAttrName) || false;
