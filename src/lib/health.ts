...
export const isServiceHealthStatus = typeGuard<ServiceHealthStatusable>('status');
...
export const isServiceHealthDiagnosable = typeGuard<ServiceHealthDiagnosable>('output');
...
export const isServiceHealthVersioned = typeGuard<ServiceHealthVersioned>('version', 'releaseId');

export interface ServiceHealthComponents {
  checks: Record<ServiceHealthComponentName, ServiceHealthComponentChecks>;
}

export const isServiceHealthComponents = typeGuard<ServiceHealthComponents>('checks');

export interface ServiceHealthLinkable {
  links: ServiceHealthLinks;
}

export const isServiceHealthLinkable = typeGuard<ServiceHealthLinkable>('links');

export interface ServiceHealthAffectable {
  affectedEndpoints: ServiceHealthAffectedEndpoints;
}

export const isServiceHealthAffectable = typeGuard<ServiceHealthAffectable>('affectedEndpoints');
...
export const isServiceHealthIdentity = typeGuard<ServiceHealthIdentity>('serviceId', 'description');
...
export const isServiceHealthSupplier = typeGuard<ServiceHealthSupplier>('serviceHealth');
...
export function healthyService(report: Omit<HealthyServiceStatus, 'status'>): HealthyServiceStatus {
...
export function healthStatusEndpoint(report: HealthServiceStatus): HealthServiceStatusEndpoint {
  return {
    headers: {
