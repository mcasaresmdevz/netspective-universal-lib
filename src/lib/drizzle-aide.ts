...
} from 'drizzle-orm/sqlite-core/utils';
...
export const primaryKeyFK = (column: AnySQLiteColumn) => text(column.name).references(() => column);
export const atTimestamp = (name: string) => integer(`${name}_at`, { mode: 'timestamp' });
